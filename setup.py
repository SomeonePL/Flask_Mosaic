...
setup(
    name='flask-mosaic',
    version='1.0',
    packages=['venv.Lib.site-packages.cv2', 'venv.Lib.site-packages.cv2.data', 'venv.Lib.site-packages.PIL',
              ...
              'venv.Lib.site-packages.flask.json', 'venv.Lib.site-packages.numpy', 'venv.Lib.site-packages.numpy.ma',
              ...
              'venv.Lib.site-packages.werkzeug.middleware', 'venv.Lib.site-packages.markupsafe',
    ...
    url='https://github.com/SomeonePL',
    license='',
    author='Andrzej Skrobak',
    author_email='skrobak.andrzej@gmail.com',
    description='Simple flask app that creates mosaic from given URLs'
)
